...
<blockquote>
<p>Quantifying the intelligence of computer systems, is of equal importance to quantifying its absence.</p>
<cite><span class="author">Thomas Kobber Panum</span><span class="role">PhD Student at Aalborg University</span></cite>
</blockquote>

With the surging expectations of modern intelligent systems, the demand for robustness acts as a corner stone for fulfilling these expectations.
Through my research as a PhD student at [[https://es.aau.dk][Department of Electronic Systems]], [[https://aau.dk][Aalborg University]] (AAU), I seek explore and expand the knowledge of robustness in machine learning methods, particularly for adversarial settings.

I obtained a M.Sc. in Machine Intelligence ([thesis](/files/msc_thesis.pdf)) and B.Sc. in Software Engineering from AAU, following some years in industry to apply machine learning for a variety of business applications.
These applications covered multiple domains, such as: medical ([[https://enversion.dk][Enversion]]), insurance ([[https://ecsact.dk][Ecsact]], [[https://tryg.com][Tryg Insurance]]) and logistics ([[https://ecsact.dk][Ecsact]]).
...
:PROPERTIES:
:EXPORT_FILE_NAME: towards_adv_phish
:EXPORT_DATE: 2020-07-01T00:00:00+02:00
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :venueshort CSET 2020
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :publisher Proceedings of the 13th USENIX Workshop on Cyber Security Experimentation and Test
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :authors '("Thomas Kobber Panum" "Kaspar Hageman" "René Rydhof Hansen" "Jens Myrup Pedersen")
:END:
...
:EXPORT_DATE: 2020-02-18T00:00:00+02:00
...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :acceptancerate 21.8
...
:PROPERTIES:
:EXPORT_FILE_NAME: usenix_v2_phish
...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :link https://www.version2.dk/artikel/nok-de-stoerste-luftkasteller-inden-it-sikkerhed-phd-kaster-kritisk-blik-paa-phishing-filtre
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :backup_url /img/backup/usenix_v2_phish.png
:END:
...
:PROPERTIES:
:EXPORT_FILE_NAME: overleaf_github_integration
:EXPORT_DATE: 2020-07-03T09:00:00+02:00
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :keywords '("overleaf" "github" "latex")
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :description Continuous GitHub mirroring of Overleaf repositories
:END:

A typical problem in life of modern academia is maintain TeX-files, and their compiled PDF form, in sync among authors of the work.
...
[[https://www.overleaf.com][Overleaf]] combats this problem by being a centralized platform of collaboration, managing TeX-files and their compiled PDF form.
...
Additionally, you might want to keep mirrors of your Overleaf papers, [[https://twitter.com/overleaf/status/1225679140772122625][in case the platform become unavailable during critical times]].
Personally, I am used to (and a fan of) GitHub's collaboration tools (issues, project, pull requests, and more) and wanted to keep my papers available on GitHub for this reason and availability.
Despite GitHub recently having introduced continuous integration in the form of [[https://github.com/features/actions][GitHub actions]], I quickly realized that compiling TeX files effectively (without massive full-tex docker images) was challenging due to the ever-evolving TeX package repositories.
...
This file was originally created by my colleague [[https://vbn.aau.dk/en/persons/121817][Egon Kidmose]] ([[https://github.com/kidmose/][@kidmose]]), I have modified it slightly and updated some components.
...
Use the following Bash-script to clone your newly formed Overleaf project (imported from GitHub).
Throughout this setup Overleaf will serve as the "master" repository, such that GitHub will just be a simply mirror, ensuring that conflicts will not occur.
#+BEGIN_SRC bash
encode() {
